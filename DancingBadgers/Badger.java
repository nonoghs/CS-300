...
public class Badger {
  ...
  /**
   * Returns a reference to the static data field of type PApplet processing.
   * 
   * @return a reference to the PApplet object modeling the display window
   */
  public static PApplet getProcessing() {
    return Badger.processing;
  }
